    ...
    def __getitem__(self, key):
        ...
        for _ in range(self.table_capacity):
            if self.array[position] is None:
                ...
                quadratic += 1
                position = (temp + quadratic ** 2) % self.table_capacity
        raise KeyError(key)
...
def dictionary_function():
    ...
    for file in filename:
        filename = file
        print("\n\n" + str(filename) + " - with Quadratic Probing \n")
...
english_small.txt - with Quadratic Probing 

b               TABLESIZE       Time (s)        Collision Count      Probe Total     Probe Max       Rehash Count   
1               250727          TIMEOUT         76483                14398622        377             0              
1               402221          TIMEOUT         75746                14184568        376             0              
1               1000081         TIMEOUT         74752                13895540        372             0              
27183           250727          0.66095         14264                20559           9               0              
27183           402221          0.649808        8988                 11242           6               0              
27183           1000081         0.73536         3494                 3887            5               0              
250726          250727          TIMEOUT         57535                13753557        665             0              
250726          402221          0.714498        8983                 11253           7               0              
250726          1000081         0.762416        3604                 3997            5               0              


english_large.txt - with Quadratic Probing 

b               TABLESIZE       Time (s)        Collision Count      Probe Total     Probe Max       Rehash Count   
1               250727          TIMEOUT         65345                11260439        329             0              
1               402221          TIMEOUT         69012                12256179        346             0              
1               1000081         TIMEOUT         67240                11770108        339             0              
27183           250727          1.665016        76435                216611          32              0              
27183           402221          1.548586        47850                82230           13              0              
27183           1000081         1.52903         19061                23618           6               0              
250726          250727          TIMEOUT         57390                13706201        677             0              
250726          402221          1.679824        47851                82828           15              0              
250726          1000081         1.520622        19052                23720           8               0              


french.txt - with Quadratic Probing 

b               TABLESIZE       Time (s)        Collision Count      Probe Total     Probe Max       Rehash Count   
1               250727          TIMEOUT         75485                13714529        306             0              
1               402221          TIMEOUT         75652                13760290        306             0              
1               1000081         TIMEOUT         74878                13546577        303             0              
27183           250727          1.945959        85184                260589          49              0              
27183           402221          1.787303        53499                96373           16              0              
27183           1000081         1.730775        22106                28727           7               0              
250726          250727          TIMEOUT         73529                14343175        556             0              
250726          402221          1.730851        53460                96217           14              0              
250726          1000081         1.724824        21780                28094           7               0              
...
This longer ammount of time is because there are many collisions and hence quasdratic probing is used to solve these collisions. 
...
inversely proportional to Tablesize, smaller Probe Totals and smaller probe chains (smaller probe Max), 
...
When compared to Linear Probing the execution time, collision count, Probe Total and probe max are all smaller on all accounts
this is because there is much less clustering when Qudratic Probing. This means fewer collisions.
The fevwer clustering also means much less probing is required to get the key-value pair to its destination,
meaning smaller probe totals abd significanlty smaller Probe Chanins,therefore smaller values of Probe Max.
