class HashTable:
    ...
    def __init__(self, table_capacity=101, hash_base=31):
        ...
        In this class, the HashTable will rehash when the load ( level of table_capacity filled) becomes more than 1/2
    ...
    def hash_Load(self):
        ...
        """
        Function used to check if the Hash Table is more than 1/2 full
        Returns True if so, false otherwise
        :return: True/False
        """

        load = self.count/self.table_capacity
        if load > 0.5:
            return True
        else:
            return False
